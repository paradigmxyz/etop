...
mod types_tests {
    ...
    fn prefix_left_align() {
        let b = BinaryFormat::new().width(6).left_align();
        assert_eq!(b.format(vec![]).unwrap(), "0x    ");
        assert_eq!(b.format(vec![2]).unwrap(), "0x02  ");
        assert_eq!(b.format(vec![2, 4, 6, 8]).unwrap(), "0x02040608");
    }
    ...
    fn prefix_right_align() {
        let b = BinaryFormat::new().width(6).right_align();
        assert_eq!(b.format(vec![]).unwrap(), "    0x");
        assert_eq!(b.format(vec![2]).unwrap(), "  0x02");
        assert_eq!(b.format(vec![2, 4, 6, 8]).unwrap(), "0x02040608");
    }
    ...
    fn prefix_left_align_zero_padding() {
        let b = BinaryFormat::new().width(6).left_align().zero_padding();
    ...
    fn prefix_right_align_zero_padding() {
        let b = BinaryFormat::new().width(6).right_align().zero_padding();
        assert_eq!(b.format(vec![]).unwrap(), "0x0000");
    ...
    fn no_prefix_left_align() {
        let b = BinaryFormat::new().width(6).left_align().no_prefix();
        assert_eq!(b.format(vec![]).unwrap(), "      ");
        assert_eq!(b.format(vec![2]).unwrap(), "02    ");
        assert_eq!(b.format(vec![2, 4, 6, 8]).unwrap(), "02040608");
    }
    ...
    fn no_prefix_right_align() {
        let b = BinaryFormat::new().width(6).right_align().no_prefix();
        assert_eq!(b.format(vec![]).unwrap(), "      ");
        assert_eq!(b.format(vec![2]).unwrap(), "    02");
        assert_eq!(b.format(vec![2, 4, 6, 8]).unwrap(), "02040608");
    }
    ...
    fn no_prefix_left_align_zero_padding() {
        let b = BinaryFormat::new().width(6).left_align().zero_padding().no_prefix();
    ...
    fn no_prefix_right_align_zero_padding() {
        let b = BinaryFormat::new().width(6).right_align().zero_padding().no_prefix();
        assert_eq!(b.format(vec![]).unwrap(), "000000");
    ...
    #[test]
    fn prefix_clip() {
        let b = BinaryFormat::new().width(6).clip();
        assert_eq!(b.format(vec![]).unwrap(), "    0x");
        assert_eq!(b.format(vec![2]).unwrap(), "  0x02");
    ...
    #[test]
    fn no_prefix_clip() {
        let b = BinaryFormat::new().width(6).clip().no_prefix();
        assert_eq!(b.format(vec![]).unwrap(), "      ");
        assert_eq!(b.format(vec![2]).unwrap(), "    02");
